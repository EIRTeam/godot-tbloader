...
void TBLoader::_bind_methods()
{
	...
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "option_skip_texture_name", PROPERTY_HINT_NONE, "Skip Texture Name"), "set_skip_texture_name", "get_skip_texture_name");
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "option_clip_texture_name", PROPERTY_HINT_NONE, "Clip Texture Name"), "set_clip_texture_name", "get_clip_texture_name");
